...
void loop() {
  ...
  sensorValue = sensorValue / avgSamples; // calculating average of the sensorvalue

  // The on-board ADC is 12-bits -> 3300 mV / 4096 steps = 0.8056 mV/step  ≈  0.806 mV/step
  // The voltage is in millivolts
  float voltage = 0.806 * sensorValue;
